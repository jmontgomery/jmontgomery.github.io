...
important to us as political scientists and citizens.  How many citizens currently approve of the president? What policies
...
The purpose of this class is to introduce you to the tools that will allow you to use data to answer
these kinds of questions.  The course will introduce basic principles of statistical inference and programming skills for data science. The goal is to provide students with the foundation necessary to analyze data in their independent research at WUSTL and to become a critical consumers of news articles and academic studies that use statistics, as well as the the first step into acquiring more advanced skills.
...
statistical procedures, understand their uses (and limitations), learn to
...
The target audience for this course is undergraduate students with interest in the social sciences (not only Political Science), who want to use quantitative approaches to solve important problems and develop analytical skills.

In today’s information world, data are available everywhere and the role of statistics is rapidly increasing in academia, business, medicine, public policy, and many other parts of the society. I strongly encourage to continue using statistics and taking more advanced classes. Please, do not hesitate to reach out if that is something of interest to you, we would be more than happy to direct you to other amazing statistics classes at WUSTL.
...
- Be able to apply basic programming concepts in the R language to tasks like collecting and re-coding data

#### Class Logistics

The class will consist of two weekly lecture sessions and one (required) lab session.  The lectures will be a combination of lectures and in-class activities focused on the relevant course materials.  The labs will be a chance to work more intensively with your peers to focus on the computational aspects of the class and to prepare yourself for the problem sets.
...
9/25| Confidence intervals <br> describing a population | AF: Chapter 5 <br> CB: Chapter 19 | 
9/27| Hypothesis testing intro |AF: Chapter 6 <br> CB: Chapters 21 - 22 | PS2 Due | [PS3 Distributed](http://jmontgomery.github.io/ProblemSets/PS3.pdf)
9/28-29| Confidence invervals in R | CB: Chapter 25
10/2| Null hypothesis testing | AF: CHapter 6 <br> CB: Chapters 23-24 |
10/4| Poster discussion | CB: Chapter 26|  PS3 Due |  Midterm review distributed
10/5-6| Functions in R (NHP) | 
10/9| Exam review | | 
10/11| Midterm | | |[PS4 Distributed](http://jmontgomery.github.io/ProblemSets/PS4.pdf)
10/16| NO CLASS <br> Fall Break
10/18| Causality | CB: Chapter 27-28 <br> AF: Chapter 10
10/19-20| Advanced plotting
10/23| Experiments: Comparing means | CB: Chapter 29 <br> AF: 7.1-7.3| 
10/25| Experiments: Contingency tables |CB: Chapter 31 <br> AF: 8.1-8.4| PS4 Due | [PS5 Distributed](http://jmontgomery.github.io/ProblemSets/PS5.pdf)
10/26-27| T-tests <br> Tables | CB: Chapters 30, 32-33
10/30| Regression and prediction | AF: 9.1-9.4 <br> CB: Chapter 34
11/1| Regression and inference | AF: 9.5  <br> CB: Chapters 35-36| 
11/2-3| Regression in R | <br> CB: Chapters 37-39
11/6| Multiple regression |  AF: 11.1-11.2, 11.4 <br> CB: Chapter 40-41
11/8| Dummies and interactions | AF:11.5 <bf> CB: Chapter 42  | PS5 Due | [PS6 Distributed](http://jmontgomery.github.io/ProblemSets/PS6.pdf)
11/9-10| Multiple regression 
11/13| Difference in differences | CB: Chapters 43-44| 
11/15| Regression discontinuity |CB: Chapters 45-46| PS6 Due | [PS7 Distributed](http://jmontgomery.github.io/ProblemSets/PS7.pdf)
11/16-17| DID and RD
11/20| Instrumental variables
11/22| NO CLASS <bf> Thanksgiving
11/27| Model fit | |
11/29| Regression diagnostics | | PS7 Due | [PS8 Distributed](http://jmontgomery.github.io/ProblemSets/PS8.pdf)

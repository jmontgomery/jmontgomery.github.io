...
- Do **NOT** sample on the independent variable 
    ...
    - To know the effet of church attendance we also have to know about the behaviors of non church goers.
...
- Be sure to include the title of your poster in the subject line of the email and the names of all members of the team in the main text.

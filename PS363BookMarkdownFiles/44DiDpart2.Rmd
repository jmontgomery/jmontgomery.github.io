...
where $\beta_1$ captures any pre-treatment differences between the treatment and control groups, $\beta_2$ captures any differences that between the pre- and post-treatment periods, and $\beta_3$ captures the effect of treatment on the treated groups.

...
\benum
 \item Load the following data: http://politicaldatascience.com/PollingCandidateData92-16.csv.
...
\beit
\item Most of the data you need is here: http://politicaldatascience.com/PollingCandidateData18.csv.

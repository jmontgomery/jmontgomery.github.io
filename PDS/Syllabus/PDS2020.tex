...
\\
1/16 & Calculation/Structures & DVM Chpt 4,5  & & PS 1 dist.\\
& & \textit{Advanced R} Chapter 2\\
\\
1/21 & Structures 2 & DVM Chpt 7 \\
& & \textit{Advanced R} Chpts. 3, 4   \\
\\
1/23 & Control/flow  & DVM Chpt 9 & PS 1 due \\
\\
1/28 & Functions  & DVM Chpt 8 &  & Teams assigned\\
& & \textit{Advanced R}  Chpt 6 \\
\\ 
1/30 & Version control & DVM Chpt 11\\
& Documentation & \textit{Advanced R}  Chapter 5, 27 \\
  \\
2/4 & Debugging & \textit{Advanced R}  Chpt 22-24 \\
& Testing/evaluating  & \\
\textbf{Section 2} \\
2/6 & \texttt{ggplot}  & \textit{R4DS} Chpt 3 & PS 2 due\\
  \\
2/11 & \texttt{dplyr} &  \textit{R4DS} Chpt 5 \\
  \\
2/13 & \texttt{tidy} & \textit{R4DS} Chpt 11-12 \\
  \\
2/18 & Relational data & \textit{R4DS} Chpt 13 \\
  \\
2/20 & Text-as-data  & \textit{R4DS} Chpt 14 & PS 3 due & Practice midterm dist.\\
& & \textit{MDSwR} Chpt 15\\
  \\
2/25 & pipes, \texttt{map}, \texttt{walk}  &  \textit{R4DS} Chpt 18, 21 \\
  \\
2/27 & Functional programming &  \textit{Advanced R} Chpt 9-11 \\
& \texttt{purrr} \\
\end{tabular}
\end{center}
\end{small}

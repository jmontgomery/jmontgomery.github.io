...
- Most complex analyses involve ore than one table of data.
...
3. Create a combined dataset of all tweets from the tweets and mentinos data.  Subset down to overlapping columns (and rename where needed) to make this easy.

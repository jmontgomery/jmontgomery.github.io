...
![  ](http://politicaldatascience.com//PDS/Slides/Images/add_code.png)
## How to add code
...
In addition to showing code and its output you can format results. If you have a set of data and you want to show summary statistics you can use the package \texttt{kable} to produce a nice table. 

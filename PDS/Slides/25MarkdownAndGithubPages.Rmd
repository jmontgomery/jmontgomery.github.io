...
- Write a paragraph about the most useful aspects of this class include the following skills:
    ...
    - Text emphasis
    - Lists
    - Hyperlinks (link to our class)
    - Images --(use this photo link:
      - http://politicaldatascience.com/PDS/Slides/Images/photo1.jpg
    - Code chunk
      - Load in the `fivethirtyeight` package into your chunk
          - {r fivethirtyeight}
      - Display the following code and its output:
...
- The first thing you will need to do is make a repository for your website
    ...
    - You already have a couple repositories created because of the problem sets
...
<img src="./Images/publish_repository.png" width="350">
...
<img src="./Images/published.png" width="400">
  ...
  - [Click it!](https://dlockett91.github.io/website/)

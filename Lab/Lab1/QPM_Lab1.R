...
# Task2: Assign the value 100 to x
...
# Task3: 1) Assign some nuermic value to the variables 'political' and 'science' and 2) Add these two variables together
...
# Task4: 1) Create three objects 2) Remove those objects

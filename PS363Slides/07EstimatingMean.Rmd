...
- Place confidence intervals int the larger story of this class
...
- We are hunting population parameters [$\mu$, $\sigma$]. \pause
    ...
    - What percentage of Americans approve of President Obama? \pause
    - How much carbon is emmitted from cars on I-64? \pause
    - What is the swage gap for women in America?

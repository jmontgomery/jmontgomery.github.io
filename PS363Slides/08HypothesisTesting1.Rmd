...
- We figured out how create a confidence interval to estimate a parameter.
...
- First, we set up a  the null  hypothesis (determined sceptic) \pause
...
We calculate a statistic summarizes how much our data differs from
...
- First, we set up a  the null
  hypothesis (determined sceptic)
...
- We would be very surprised to observe a jury with this few Mexican-Americans or less if if $\pi = 0.791$ \pause

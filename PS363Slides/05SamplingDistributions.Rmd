...
# vector is of length 20
x.bars<-rep(NA, sample.size) 
# Now we are going to "loop" over the vector 1, 2, ..., 20
# in each iteration the variable "i" will increment up on value
for(i in 1:sample.size){
  # Draw a random sample
  this.sample<-sample(x, size = n.samples, replace=F) 
...
# Create a vector filled with NA (missing data) 
# vector is of length 2000
x.bars<-rep(NA, sample.size) 
# Now we are going to "loop" over the vector 1, 2, ..., 2000
# in each iteration the variable "i" will increment up on value
for(i in 1:sample.size){
  # Draw a random sample
  this.sample<-sample(x, size = n.samples, replace=F) 
